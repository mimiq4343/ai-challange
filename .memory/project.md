...
- Основные проверки: targeted ESLint, `npx tsc --noEmit`, `npm run test:compression`, `npm run test:tokens`, `npm run test:persistence` и `npm run build` перед интеграцией.
