...
собраны дни с 1 по 12; ветка `day-13` добавляет формализованное состояние
задачи: конечный автомат с этапами, шагами и ожидаемым действием, который
переживает паузу и смену диалога. Персонализация Day 12 в этой ветке выключена
флагом — код и данные сохранены.
...
| Ветка   | Что в ней                                        |
| ------- | ------------------------------------------------ |
| `main`  | Стабильная версия приложения, сейчас Day 12      |
