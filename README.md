...
собраны дни с 1 по 11; ветка `day-12` добавляет персонализацию поверх модели
памяти: профиль пользователя со стилем, форматом и ограничениями, который
уходит в каждый запрос и владеет своей долговременной памятью.
