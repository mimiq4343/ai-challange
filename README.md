...
`main` собраны дни с 1 по 14: измерение токенов, сжатие истории, стратегии
управления контекстом, модель памяти, персонализация, формализованное состояние
задачи и инварианты проекта, из-за которых запрос может не дойти до модели.
...
| Ветка   | Что в ней                                        |
| ------- | ------------------------------------------------ |
| `main`  | Стабильная версия приложения, сейчас Day 14      |
