...
`main` собраны дни с 1 по 12: измерение токенов, сжатие истории, стратегии
управления контекстом, явная модель памяти агента и персонализация — профиль
пользователя со стилем, форматом и ограничениями, который уходит в каждый запрос
и владеет своей долговременной памятью.
